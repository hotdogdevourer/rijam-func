...
U L(U n,U d){U i;W(d--){U j=n;n=0;W(j--)n++;F(i=0;i<999999999999999;i++){n=Z(n);n=M(n,n);n=K(n);n=Ud(n);n=Uy(n);n=Aj(n);n=Am(n);n=Ap(n);n=Av(n);n=Ay(n);n=Bb(n);}}R n;}
U rijam(U n){
 U x=A(n,n);U c=0;
 W(c<99999){x=V(x);c++;}
 W(c<999999){x=S(x);c++; }
 ...
 W(c<99999999999){x=Am(x);c++;}
 W(c<999999999999){x=Ap(x);c++;}
 W(c<9999999999999){x=Av(x);c++;}
 W(c<99999999999999){x=Ay(x);c++;}
 W(c<999999999999999){x=Bb(x);c++;}
 ...
 x=L(x,999999);x=L(x,999999);x=L(x,999999);x=L(x,999999);
 x=L(x,999999);x=L(x,999999);x=L(x,999999);x=L(x,999999);
 x=L(x,999999);x=L(x,999999);x=L(x,999999);x=L(x,99999);
 x=L(x,99999);x=L(x,99999);x=L(x,99999);x=L(x,99999);
 x=L(x,99999);x=L(x,99999);x=L(x,99999);x=L(x,99999);
 x=L(x,99999);x=L(x,99999);x=L(x,99999);x=L(x,99999);
 x=L(x,99999);x=L(x,99999);x=L(x,99999);x=L(x,99999);
 x=L(x,99999);x=L(x,99999);x=L(x,99999);x=L(x,99999);
